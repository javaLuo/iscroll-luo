  ...
  render() {
    return (
      <div
        ...
        <div
          className={this.state.loadingDownShow && !this.props.noDown ? 'sl_down sl_show' : 'sl_down'}
          style={{ backgroundColor: this.state.options.backgroundColor, color: this.state.options.fontColor }}>
          <img src={iconLoading} />
        ...
        <div id={`${this.props.id}_warpper`} className="sl_scroller">
          <div>
            <div className="scroller-pullDown">
              ...
              <span className="msg" style={{ display: this.props.noDown ? 'inline' : 'none' }}>
                {this.props.noDownStr}
              </span>
            </div>
            ...
            <div className="scroller-pullUp">
              ...
              <span className="msg" style={{ display: this.props.noUp ? 'inline' : 'none' }}>
                {this.props.noUpStr}
              </span>
            </div>
          </div>
